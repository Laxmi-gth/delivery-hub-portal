...
```markdown
# 📦 Delivery Hub Portal – Project Plan
**Logistics Company: USA ↔ India Shipments**  
...
|--------------|-------------|------------------------------------------|
| Phase 1      | Week 1–2    | Authentication, admin base setup         |
| Phase 2      | Week 3–4    | Lead system & customer database          |
| Phase 3      | Week 5–6    | Shipment management                      |
| Phase 4      | Week 7–8    | Payment, invoice system                  |
| Phase 5      | Week 9–10   | Expenses, rate card, profit/loss ledger  |
| Phase 6      | Week 11–12  | Franchise manager, customer history      |
